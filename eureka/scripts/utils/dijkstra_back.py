...
### robot planning
MovingDict = { "0to1": ["PickLL","PickMR","PouringLtoR","PlaceLL","PlaceMR"],
               "0to2": ["PickLL","PickRR","PouringLtoR","PlaceLL","PlaceRR"],
               "1to2": ["PickML","PickRR","PouringLtoR","PlaceML","PlaceRR"],
               "1to0": ["PickLL","PickMR","PouringRtoL","PlaceLL","PlaceMR"],
               "2to0": ["PickLL","PickRR","PouringRtoL","PlaceLL","PlaceRR"],
               "2to1": ["PickML","PickRR","PouringRtoL","PlaceML","PlaceRR"]
}
...
def Planning(pose):
  ...
  for i in range(len(out)):
    ...
    if out[i][:6] == "PickLL":
        movement.append("gripOFF_L")   
        movement.append("fLL") 
        movement.append("gripON_L") 
        movement.append("bLL") 

    elif out[i][:7] == "PlaceLL":
        movement.append("fLL")   
        movement.append("gripOFF_L") 
        movement.append("bLL") 
        movement.append("gripON_L") 
        ...
        movement.append("gripOFF_R")   
        movement.append("fRR") 
        movement.append("gripON_R") 
        movement.append("bRR") 

    elif out[i][:7] == "PlaceRR":
        movement.append("fRR")   
        movement.append("gripOFF_R") 
        movement.append("bRR") 
        movement.append("gripON_R") 
